...
class Googlemaps {
	...
	var $apiKey						= 'AIzaSyBM9-QJhHTP_yCndkOE8hW4OdfjULyv_MY'; 						// If you've got an API key you can use it by passing this parameter. Setup an API key here: https://code.google.com/apis/console
